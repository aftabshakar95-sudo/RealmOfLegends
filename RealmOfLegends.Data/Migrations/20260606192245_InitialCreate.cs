        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyReset = table.Column<bool>(type: "bit", nullable: false),
                    WeeklyReset = table.Column<bool>(type: "bit", nullable: false),
                    QuestData = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ArenaProgresses",
                columns: table => new
                {
                    ArenaProgressId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlayerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArenaProgresses", x => x.ArenaProgressId);
                    table.ForeignKey(
                        name: "FK_ArenaProgresses_Players_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FightLogId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlayerId = table.Column<int>(type: "int", nullable: false),
                    Level = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FightLogs_Items_DroppedItemId",
                        column: x => x.DroppedItemId,
                        principalTable: "Items",
                        principalColumn: "ItemId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FightLogs_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "PlayerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlotType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArenaProgresses_PlayerId",
                table: "ArenaProgresses",
                column: "PlayerId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FightLogs_DroppedItemId",
                table: "FightLogs",
                column: "DroppedItemId");

            migrationBuilder.CreateIndex(
                name: "IX_FightLogs_PlayerId",
                table: "FightLogs",
                column: "PlayerId");
